...
/* Locators */
const slider_image =
  '//div[@class="wp-block-cover alignfull is-light has-parallax lazy"]';
const slider_title =
...
export class CarouselSlider {
  verifysliderImage() {
    cy.xpath(slider_image, { timeout: 10000 }).scrollIntoView().should("be.visible");
  }

  verifysliderTitle(act_slider_title) {
    cy.xpath(slider_title).should("be.visible");
