...
export class Categories {
    ...
    verifyCategoriesHeader(act_categories_text) {
        ...
        cy.xpath(categories).invoke('text').then((exp_categories_text) => {
    ...
    verifyCategoriesName(act_category_name) {
        const category_name = '//figcaption[contains(text(),"'+act_category_name+'")]'
            cy.xpath(category_name).should('be.visible')
            cy.xpath(category_name).invoke('text').then((exp_categorie_name) => {
